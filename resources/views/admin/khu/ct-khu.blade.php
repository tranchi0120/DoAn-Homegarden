...
@section('content')
    ...
    <div class="form">
        ...
        <div class="row">
            <h3 class="name">Ngày Trồng : </h3 class="name">
            <span class="content">{{ $data->NgayTrongCay }}</s>
        </div>

        <div class="row">
            <h3 class="name">Ngày Cây Có Thể Bán :</h3 class="name">
            <span class="content">{!! $data->NgayThuHoach !!}</s>
        </div>
